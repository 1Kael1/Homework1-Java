...
public class Task {
    public static void main(String[] args) {
        ...
        System.out
                .println("Common prefix for " + Arrays.toString(stringArray) + " -> " + findCommonPrefix(stringArray)); // aa
        String[] stringArray2 = { "abc", "bca", "cda" };
        System.out.println(
                "Common prefix for " + Arrays.toString(stringArray2) + " -> " + findCommonPrefix(stringArray2)); // ""
        System.out.println("");
        ...
        System.out.println(
                "Создать квадратный двумерный целочисленный массив (количество строк и столбцов одинаковое), с помощью цикла(-ов) заполнить его диагональные элементы единицами.");
